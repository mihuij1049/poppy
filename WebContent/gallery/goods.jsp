...
<body>
        ...
        <div class="content">
            ...
            <div class="product">
                ...
                <fieldset class="btn-group">
                    ...
                    <input id="my-url" type="text" value="<?php echo esc_url($_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'])?>" style="display: none;">
                </fieldset>
                <div class="prd-title">
                    <div class="prd-name">대용량노즈워크용 간식/벨버드 순삭져키 1kg 강아지져키</div>
                    <div class="prd-price">
                        <div class="price">19900</div>원
                    </div>
                        ...
                        <table>
                            <tbody>
                                <tr class="quantity">
                                    <th>수량</th>
                                    <td>
                                        <button type="button" class="btn btnDown"><img src="../share/img/마이너스.png"></button>
                                        <input type="number" value="1" min="1" max="99" name="count" id="count" />
                                        <button type="button" class="btn btnUp"><img src="../share/img/플러스.png"></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="prd-total">
                        ...
                        <div class="total-price">
                            <b id="total-price">19,900</b>
                            <b>원</b>
                            <b>(</b><b id="price-count">1</b><b>개)</b>
                        </div>
                    </div>
                    <div class="prd-action">
                        <div class="action-btn">
                            <button type="button" onclick="location.href='../pay/cart.jsp'" id="action-cart">장바구니</button>
                            <button type="button" onclick="location.href='../myInfo/like_goods.jsp'" id="action-like">관심상품</button>
                            <button type="button" onclick="location.href='../pay/orderform.jsp'" id="action-orderform">구매하기</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active in" id="page1">
                        <div class="prd-detail">
                            <img src="../share/img/goods_content.jpg">
                            <img src="../share/img/goods_content2.jpg">
                            <img src="../share/img/goods_footer.jpg" id="prd-foot">
                        </div>
                    </div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <sapn>
                                                대용량노즈워크용 간식/벨버드 순삭져키 1kg 강아지져키
                                            </sapn>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="page3">
                        <div class="prd-photo">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="afile">
                                                    ...
                                                    <img src="../share/img/photo-file.PNG" border="0" onclick="document.all.file1.click(); document.all.file2.value=document.all.file1.value">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="afile">
                            ...
                            <div class="photo-button">
                                ...
                                <button type="button" id="review-all" onclick="location.href='../community/photo_rv.jsp'">리뷰 전체보기</button>
                            </div>
                                        ...
                                        <div class="box">
                                            <dl class="box-left">
                                                ...
                                                <dd class="review-content">
                                                    대용량 간식 찾고있었는데 너무 좋아요<br>
                                                    크기도 적당해서잘먹네요 <br>많이 파세요많이 파세요많이 파세요많이 파세요많이 파세요<br>
                                                </dd>
                                                <dd class="edit">
                                    ...
                                    <li class="list2">
                                        <div class="box">
                                            <dl class="box-left">
                                                ...
                                                <dd class="review-content">
                                                    구매해주셔서 정말 감사합니다~!<br>
                                                    리뉴얼 한만큼 더 열심히 더 좋은 상품으로 보답하겠습니다.<br>
                                                    오늘 하루 행복한 하루되세요~!<br>
                                                    리뷰 정말 감사합니다!
                                                </dd>
                                                <dd class="edit">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="page4">
                        <div class="prd-qna">
                            <div class="qna-head">
                                <p class="qna-btn">
                                    <button type="button" onclick="location.href='../community/qna_wri.jsp'" id="qna-write">상품문의하기</button>
                                    <button type="button" onclick="location.href='../community/qna.jsp'" id="qna-all">모두보기</button>
                                </p>
                                <p class="nodata">
                                    게시물이 없습니다
                                </p>
    ...
    $(function() {
        $('.like-btn').click(function() {
            ...
            $('#like-count').toggleClass("change_color2");
        });
