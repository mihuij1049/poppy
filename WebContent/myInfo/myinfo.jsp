        ...
        <div class="content">
            ...
            <div class="container">
                <div class="page-title clearfix">
                    <h4><b>
                            <a href="#" onclick="history.back(); return false;"><i class="glyphicon glyphicon-chevron-left"></i></a>내정보
                        </b></h4>
                </div>
                <div class="mypoint">&nbsp;적립금 :&nbsp; <b>3,000</b>원</div>
                <div class="mydelivery clearfix">
                    <div class="mydelivery-current">입금전<br><span>0</span></div>
                    <div class="mydelivery-current">배송준비중<br><span>0</span></div>
                    <div class="mydelivery-current">배송중<br><span>0</span></div>
                    <div class="mydelivery-current">배송완료<br><span>0</span></div>
                </div>
                <div class="myinfo-list clearfix">
                    <div id="list-alt" class="myinfo-list-item"><a href="order_list.jsp"><span class="glyphicon glyphicon-list-alt"></span></span><br>주문조회 </a></div>
                    <div id="user" class="myinfo-list-item"><a href="myinfo_edit.jsp"><span class="glyphicon glyphicon-user"></span><br>회원정보</a></div>
                    <div id="thumb" class="myinfo-list-item"><a href="like_goods.jsp"><span class="glyphicon glyphicon-thumbs-up"></span><br>좋아요</a></div>
                    <div id="point" class="myinfo-list-item"><a href="point.jsp"><span class="glyphicon glyphicon-usd"></span><br>적립금</a></div>
                    <div id="commu" class="myinfo-list-item"><a href="my_rv.jsp"><span class="glyphicon glyphicon-folder-open"></span><br>후기관리</a></div>
                    <div id="recent" class="myinfo-list-item"><a href="recent.jsp"><span class="glyphicon glyphicon-eye-open"></span><br>최근본상품</a></div>
                </div>
            </div>
        </div>
        <div class="footer">
