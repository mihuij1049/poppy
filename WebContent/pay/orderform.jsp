...
<body>
    ...
    <form id="orderform" class="orderform" action="" method="post" target="_self" enctype="multipart/form-data">
                ...
                <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs" id="mytab">
                            <li class="active"><a href="#page1" data-toggle="tab">최근 배송지</a></li>
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="page1">
                                <div class="recent-address">
                                    ...
                                    <span class="side-right">
                                        <button type="button" id="recent-address-list">
                                            배송지 목록
                                        </button>
                                    </span>
                                    <hr>
                                    <div class="form-group">
                                        ...
                                        <textarea id="selboxDirect" name="selboxDirect" style="resize: none;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div role="tabpanel" class="tab-pane fade" id="page2">
                                <div class="new-address">
                                    <div class="segment same-addr">
                                        ...
                                        <div class="new">
                                            <input type="radio" name="same-addr" id="same-addr2" />
                                            <label for="same-addr2">새로운 배송지</label>
                                        </div>
                                    </div>
                                    <div class="new-addr">
                                        <div class="na-name">
                                        ...
                                        <div class="na-address">
                                            ...
                                            <div class="na-address-body">
                                                ...
                                                <input type="button" id="address-btn" onclick="DaumPostcode()" value="주소 찾기"><br>
                                                <input type="text" id="address" placeholder="주소"><br>
                                                <input type="text" id="detail-address" placeholder="상세주소">
                                                <div id="wrap" style="display:none;border:1px solid;width:343px;height:390px;margin:5px 0;position:relative;border:1px solid#ddd;">
                                            ...
                                            <div class="na-phone">
                                                ...
                                                <div class="na-phone-body">
                                                    <div class="input-text">
                                                        <input type="text" name="delivery-phone" id="delivery-phone" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class=" na-email">
                                                ...
                                                <div class="na-email-body">
                                                    <div class="input-text">
                                                        <input type="text" name="delivery-email" id="delivery-email" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group2">
                                        ...
                                        <textarea id="selboxDirect2" name="selboxDirect" style="resize: none;"></textarea>
                                    </div>
                                    <div class="addr-save">
                                ...
                                <div class="prd">
                                    <div id="prd-title">
                                        <strong class="prd-name" title="상품명">
                                            <a href="../gallery/goods.jsp">펫클럽 벨버드 토일렛/애견토일렛/강아지화장실/패드</a>
                                        </strong>
                                    </div>
                                    <ul class="prd-li">
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-delete" data-dismiss="modal">예</button>
                ...
                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                    <div class="panel-body">
                        <div class="discount clear">
                            <div class="dis-title">
                                <span class="head">쿠폰 할인</span>
                                <span class="coupon">
                                    ( 보유쿠폰
                                    <span class="coupon-count">3개</span>
                                    )
                                </span>
                            </div>
                            <div class="discount-re">
                                <button type="button" class="btn btn-default" id="btn-coupon-sel">쿠폰 적용</button>
                        ...
                        <div class="total">
                            ...
                            <strong class="total-sum">
                                -
                                <span id="totla-sale-price">0</span>원
                            </strong>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="pay-info">
                            <div class="pay-content">
                                <div class="pay-con1">
                                    ...
                                    <span class="total-price">
                                        <span id="total-gallery-price">6,900</span>원
                                    </span>
                                </div>
                                <div class="pay-con2">
                                    <h5>할인/부가결제</h5>
                            ...
                            <div class="pay-price">
                                ...
                                <strong class="total-price">
                                    <span id="pay-price">9,400</span>원
                                </strong>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                    <div class="panel-body">
                        ...
                        <div class="save">
                            <input type="checkbox" name="pay-method-save" id="pay-method-save">
                            <label for="pay-method-save">결제수단과 입력정보를 다음에도 사용</label>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="save-point">
                            <div class="save-content">
                                <div class="save-con1">
                                    <h5>상품별 적립금</h5>
                                    <span class="total-price">
                                        <span id="total-gallery-price">70</span>원
                                    </span>
                                </div>
                                <div class="save-con2">
                                    <h5>회원 적립금</h5>
