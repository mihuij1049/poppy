...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="container">
                <div class="page-title clearfix">
                    <a href="#" onclick="history.back(); return false;"><img src="../share/img/back.jpg"></a>
                    <h4><b>이용안내</b></h4>
                </div>
            </div>
            <div class="info">
        ...
        <div class="footer">
            ...
            <hr />
            <div class="etc">
                <a href="page_info1.jsp">회사소개</a>
                <a href="page_info2.jsp">이용약관</a>
                <a href="page_info3.jsp">개인정보취급방침</a>
                <a href="page_info4.jsp">이용안내</a>
            </div>
            <hr />
            <div class="row">
