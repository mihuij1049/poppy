...
<div class="content">
            <!-- 여기에 작성 -->
                ...
                <div class="page-title clearfix">
                    <h4><b>
                            <a href="#" onclick="history.back(); return false;"><i class="glyphicon glyphicon-chevron-left"></i></a>아이디찾기
                        </b></h4>
                </div>
                <form method="post" class="find" id="find" action="../member/find_id_ok.jsp">
                    <div class="member">
                        <b>회원구분</b>
