            ...
            <div class="container">
                ...
                <form id="agree_form">
                    <div class="all_select">
                        <div>
                            <div class="cb_mg">
                                <input type="checkbox" name="select-all" id="select-all"><b>이용약관 및 개인정보수집 및 이용, <br /> 쇼핑정보 수신(선택)에 모두 동의합니다.</b></font></input></div>
                        </div>
                        <div class="agree_1">
                            <div class="agree_ck">
                                <input type="checkbox" name="checkbox" class="checkbox checkbox_y">이용약관 동의(필수)</input>
                                <span><a href="../etc/page_info2.jsp">전체보기</a></span>
                            </div>
                            <div class="long_text">
                        ...
                        <div class="agree_1">
                            <div class="agree_ck">
                                <input type="checkbox" name="checkbox" class="checkbox checkbox_y">개인정보처리방침 동의(필수)</input>
                                <span><a href="../etc/page_info3.jsp">전체보기</a></span>
                            </div>
                            ...
                            <div class="long_text">
                                ...
                                <p>o&nbsp;위탁 대상자 : 공급업체 목록보기<br>o&nbsp;위탁업무 내용 : [위탁업무 내용]</p>
                        ...
                        <div class="agree_2">
                            <input type="checkbox" name="checkbox" class="checkbox checkbox_n"> 쇼핑정보 수신 동의(선택)
                        </div>
                        <div class="agree_2">
                            <input type="checkbox" name="checkbox" class="checkbox checkbox_n"> 이메일 수신동의
                        </div>
                        <div class="agree_2">
                            할인쿠폰 및 혜택, 이벤트, 신상품 소식 등 쇼핑몰에서 제공하는 유익한 쇼핑정보를 이메일로 받아보실 수 있습니다.
                        </div>
                        <div class="btns">
