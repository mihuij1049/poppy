...
<body>
    ...
    <div class="content">
            ...
            <div class="container">
                ...
                <div class="subject">
                    <b>☆뽀삐뽀삐 사이트 오픈 공지☆</b><br>
                    <small>(주)뽀삐뽀삐 | <span>2020.01.29</span> | 조회<span>215</span></small>
                </div>
                <hr>
                <div class="nai">
                    <p>
                        안녕하세요! 뽀삐뽀삐 입니다:)<br>
                        premium dog food and itet<br>
                        댕댕이들을 위한 쇼핑몰 뽀삐뽀삐<br>
                        사이트를 오픈하였습니다.<br>
                    </p>
                </div>
                <div class="comment">
                    <button type="button" onclick="location.href='notice.jsp'" class="btn btn-inverse btn-sm list">목록</button>
                </div>
                ...
                <div class="comment-write">
                    <div class="info-name">
                        <label for="name-write">이름</label>
                        <input type="text" name="name-write" class="information1" id="name-write">
                    </div>
                    <div class=info-pass>
                        <label for="pass-write">비밀번호</label>
                        <input type="text" name="pass-write" class="information2" id="pass-write">
                    </div>
                </div>
                <textarea class="comment_area" placeholder="내용을 입력하세요." maxlength="1800"></textarea>
                <button type="submit" class="enter btn btn-sm">등록</button>
            </div>
            <div class="next">
                <p><b>다음글&nbsp;&nbsp;&nbsp;</b>
                    <span><a href="#">신규 회원가입 고객 혜택안내</span></p></a>
            </div>
            <div class="solid">
            </div>
        </div>
