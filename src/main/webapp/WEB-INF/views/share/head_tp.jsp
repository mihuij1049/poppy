...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/share/searchtab.css" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/share/categorytab.css" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/share/menu.css" />
<!-- AjaxHelper -->
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/share/plugins/ajax/ajax_helper.css" />
<!-- 반응형 웹을 지원하지 않을 경우 -->
