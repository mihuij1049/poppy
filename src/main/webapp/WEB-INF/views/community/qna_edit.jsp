...
<body>
	...
	<div class="content">
		...
		<div class="container">
			...
			<!-- 모달창 끝 -->
			<form name="qna_wri" id="editForm" action="${pageContext.request.contextPath}/community">
				<div class="container">
    ...
    $(function() {
        ...
        $("#editForm").ajaxForm({
            ...
            success: function(json) {
                ...
                if (json.rt == "OK") {
                    window.location = "${pageContext.request.contextPath}/community/qna.do?bbsno=" + json.item.bbsno;
                }
            }
        });
    });
