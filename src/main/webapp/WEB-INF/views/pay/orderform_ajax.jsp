					...
					<div class="panel-body">
						...
						<div role="tabpanel" class="tab-pane fade" id="page2">
							<div class="new-address">
								...
								<div class="addr-save">
									<input type="checkbox" name="default"> <span> 기본
										배송지로 저장 </span>
								</div>
							</div>
						</div>
				...
				<form class="panel-body"
					...
					<div class="discount clear">
						...
						<div class="discount-re">
							<button type="button" class="btn btn-default" id="btn-coupon-sel">적립금
								적용</button>
				...
				<div class="panel-body">
					<div class="pay-info">
						<div class="pay-content">
							<div class="pay-con1">
								<h5>주문상품</h5>
								<span class="total-price"> <span id="total-gallery-price">6,900</span>원
								</span>
							</div>
							<div class="pay-con2">
								<h5>할인/부가결제</h5>
				...
				<div class="panel-body">
					<div class="save-point">
						<div class="save-content">
							<div class="save-con1">
								<h5>상품별 적립금</h5>
								<span class="total-price"> <span id="total-gallery-price">70</span>원
								</span>
							</div>
							<div class="save-con2">
								<h5>회원 적립금</h5>
